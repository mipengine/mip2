...
describe('sandbox', function () {
  ...
  it('strict', function () {
    ...
    expect(Object.keys(sandbox.strict.MIP.sandbox.document)).to.be.deep.equal(['cookie', 'domain', 'title'])
    ...
    expect(Object.keys(sandbox.strict.document)).to.be.deep.equal(['cookie', 'domain', 'title'])
